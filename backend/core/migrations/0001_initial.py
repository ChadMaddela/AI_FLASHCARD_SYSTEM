# Generated by Django 6.0.6 on 2026-06-09 00:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('teacher', 'Teacher'), ('student', 'Student'), ('expert', 'Expert/Evaluator')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_style', models.IntegerField()),
                ...
                ('evaluator', models.ForeignKey(limit_choices_to={'role': 'expert'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Topic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_type', models.CharField(choices=[('pretest', 'Pretest'), ('posttest', 'Posttest')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('micro_tags', models.TextField(blank=True, default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_attempt_correct', models.BooleanField(blank=True, null=True)),
                ('repetitions', models.IntegerField(default=0)),
                ('easiness_factor', models.FloatField(default=2.5)),
                ('interval', models.IntegerField(default=0)),
                ('last_reviewed', models.DateTimeField(auto_now=True)),
                ('next_review_due', models.DateTimeField(auto_now_add=True)),
